...
export class RecipeService {
  ...
  recipes: Recipe[] = [
    new Recipe(
      ...
      [
        new Ingredient('Ingredient', 4, 'gr', 60),
        new Ingredient('Ingredient', 1, 'gr', 2),
        new Ingredient('Ingredient', 4, 'gr', 3),
        new Ingredient('Ingredient', 1, 'gr', 4),
        new Ingredient('Ingredient', 4, 'gr', 5),
        new Ingredient('Ingredient', 1, 'gr', 6),
        new Ingredient('Ingredient', 4, 'gr', 7),
        new Ingredient('Ingredient', 1, 'gr', 8),
        new Ingredient('Ingredient', 4, 'gr', 23),
        new Ingredient('Ingredient', 1, 'gr', 44),
        new Ingredient('Ingredient', 4, 'gr', 23),
        new Ingredient('Ingredient', 1, 'gr', 55),
        new Ingredient('Ingredient', 4, 'gr', 23),
        new Ingredient('Ingredient', 1, 'gr', 55),
      ],
      [
